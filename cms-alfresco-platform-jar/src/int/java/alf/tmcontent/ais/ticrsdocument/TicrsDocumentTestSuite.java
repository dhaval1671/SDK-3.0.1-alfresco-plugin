...
@Suite.SuiteClasses({
    ...
    CreateTicrsDocumentTests.class,
    RetrieveTicrsDocumentContentTests.class,
    RetrieveTicrsDocumentMetadataTests.class,
    TiffJpegRetrieveTicrsDocumentContentTests.class

})
public class TicrsDocumentTestSuite {
