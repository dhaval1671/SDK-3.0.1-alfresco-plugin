...
public class RetrieveExhibitMetadataTests extends ExhibitBaseTest {
    ...
    /**
     * Test retrieve exhibit metadata.
     */
    @Test
    public void testRetrieveExhibitMetadata() {
        ...
        String EXHIBIT_RETRIEVE_METADATA_WEBSCRIPT_URL = LegalProceedingUrl.retrieveDocumentMetadata(urlInput);         
        WebResource webResource = client.resource(EXHIBIT_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        //check for Exhibit document's size presence
        ...
        String docType = "\"documentType\"(.*?)\""+ Exhibit.TYPE + "\"";
        assertTrue(containsOneOrMoreOccurencesOfProvidedStringOfGivenRegEx( haystack, docType));          
    }

    /**
     * Test retrieve exhibit metadata with valid version.
     */
    @Test
    public void testRetrieveExhibitMetadataWithValidVersion() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_EXHIBIT.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_EXHIBIT_FILE_NAME);
        urlInput.setAccessLevel("internal");
    ...
    /**
     * Test retrieve exhibit metadata exhibit doesnt exists.
     */
    @Test
    public void testRetrieveExhibitMetadataExhibitDoesntExists() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_EXHIBIT.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
