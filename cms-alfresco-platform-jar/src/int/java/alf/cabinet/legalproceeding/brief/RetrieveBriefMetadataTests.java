...
public class RetrieveBriefMetadataTests extends BriefBaseTest {
    ...
    /**
     * Test retrieve brief metadata.
     */
    @Test
    public void testRetrieveBriefMetadata() {
        ...
        String BRIEF_RETRIEVE_METADATA_WEBSCRIPT_URL = LegalProceedingUrl.retrieveDocumentMetadata(urlInput);         
        WebResource webResource = client.resource(BRIEF_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        //check for Brief document's size presence
        ...
        String docType = "\"documentType\"(.*?)\""+ Brief.TYPE + "\"";
        assertTrue(containsOneOrMoreOccurencesOfProvidedStringOfGivenRegEx( haystack, docType));          
    }

    /**
     * Test retrieve brief metadata with valid version.
     */
    @Test
    public void testRetrieveBriefMetadataWithValidVersion() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_BRIEF.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_BRIEF_FILE_NAME);
        urlInput.setAccessLevel("internal");
    ...
    /**
     * Test retrieve brief metadata brief doesnt exists.
     */
    @Test
    public void testRetrieveBriefMetadataBriefDoesntExists() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_BRIEF.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
