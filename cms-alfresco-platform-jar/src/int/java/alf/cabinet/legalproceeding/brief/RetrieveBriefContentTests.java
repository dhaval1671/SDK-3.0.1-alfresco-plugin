...
/**
 * Retrieve Brief Content test cases.
 * 
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk}
 *
 */

public class RetrieveBriefContentTests extends BriefBaseTest {
    ...
    /**
     * Test retrieve brief content.
     */
    @Test
    public void testRetrieveBriefContent() {
        ...
        String BRIEF_RETRIEVE_CONTENT_WEBSCRIPT_URL = LegalProceedingUrl.retrieveContentGenericUrl(urlInput);
        WebResource webResource = client.resource(BRIEF_RETRIEVE_CONTENT_WEBSCRIPT_URL);
    ...
    /**
     * Test retrieve brief content for invalid serial number.
     */
    @Test
    public void testRetrieveBriefContentForInvalidSerialNumber() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_BRIEF.getAlfrescoTypeName());
    ...
    /**
     * Test retrieve brief content brief dosnt exists.
     */
    @Test
    public void testRetrieveBriefContentBriefDosntExists() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_BRIEF.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
    ...
    /**
     * Test retrieve brief content where file name supplied is blank.
     */
    @Test
    public void testRetrieveBriefContentWhereFileNameSuppliedIsBlank() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_BRIEF.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
