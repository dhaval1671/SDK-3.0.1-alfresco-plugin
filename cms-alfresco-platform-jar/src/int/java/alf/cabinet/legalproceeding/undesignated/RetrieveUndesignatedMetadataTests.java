...
public class RetrieveUndesignatedMetadataTests extends UndesignatedBaseTest {
    ...
    /**
     * Test retrieve undesignated metadata.
     */
    @Test
    public void testRetrieveUndesignatedMetadata() {
        ...
        String UNDESIGNATED_RETRIEVE_METADATA_WEBSCRIPT_URL = LegalProceedingUrl.retrieveDocumentMetadata(urlInput);         
        WebResource webResource = client.resource(UNDESIGNATED_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        //check for Undesignated document's size presence
        ...
        String docType = "\"documentType\"(.*?)\""+ Undesignated.TYPE + "\"";
        assertTrue(containsOneOrMoreOccurencesOfProvidedStringOfGivenRegEx( haystack, docType));          
    }

    /**
     * Test retrieve undesignated metadata with valid version.
     */
    @Test
    public void testRetrieveUndesignatedMetadataWithValidVersion() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_UNDESIGNATED.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_UNDESIGNATED_FILE_NAME);
        urlInput.setAccessLevel("internal");
    ...
    /**
     * Test retrieve undesignated metadata undesignated doesnt exists.
     */
    @Test
    public void testRetrieveUndesignatedMetadataUndesignatedDoesntExists() {
        LegalProceedingUrlInputDto urlInput = new LegalProceedingUrlInputDto(TradeMarkLegalProceedingTypes.TYPE_UNDESIGNATED.getAlfrescoTypeName());
        urlInput.setProceedingNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
