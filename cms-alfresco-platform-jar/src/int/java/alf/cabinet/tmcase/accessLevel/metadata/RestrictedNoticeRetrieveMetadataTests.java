...
public class RestrictedNoticeRetrieveMetadataTests extends CentralBase {
    ...
    public void createAndRetrveRestrictedNoticeConWithClientReqAccessLevelPublic() {
        ...
        urlInput.setFileName("AccessLevelRestrictedNotice_RtrveMetadata.pdf");
    ...
    private void retrieveRestrictedNoticeWithClientRequestRestrictedAccessLevel(UrlInputDto urlInput) {
        ...
        String haystack = str;
        String docType = "\"accessLevel\"(.*?)\""+ "restricted" + "\"";
