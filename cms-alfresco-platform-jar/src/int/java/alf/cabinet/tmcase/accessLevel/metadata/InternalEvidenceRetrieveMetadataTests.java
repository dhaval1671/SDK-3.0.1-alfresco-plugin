...
public class InternalEvidenceRetrieveMetadataTests extends CentralBase {
     ...
     */
    @Test
    public void createAndRetrveRestrictedEvidenceMetadataWithClientReqAccessLevelPublic() {
        ...
        urlInput.setFileName("AccessLevelInternalEvidence_RtrveMetadata.pdf");
    ...
    private void retrieveRestrictedEvidenceWithClientRequestNOAccessLevel(UrlInputDto urlInput) {
        ...
        String EVIDENCE_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);
        //System.out.println(EVIDENCE_RETRIEVE_METADATA_WEBSCRIPT_URL);
        WebResource webResource = client.resource(EVIDENCE_RETRIEVE_METADATA_WEBSCRIPT_URL);
    ...
    private void retrieveInternalEvidenceWithClientRequestInternalAccessLevel(UrlInputDto urlInput) {
        ...
        String haystack = str;
        String docType = "\"accessLevel\"(.*?)\""+ "internal" + "\"";
