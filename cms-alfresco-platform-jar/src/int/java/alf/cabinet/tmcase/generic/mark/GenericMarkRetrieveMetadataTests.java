...
public class GenericMarkRetrieveMetadataTests extends GenericMarkBaseTest {
    ...
    public void testRetrieveMarkMetadata() {
        ...
        // System.out.println(MARK_METADATA_WEBSCRIPT_URL);
     ...
     */
    @Test
    public void testRetrieveMarkMetadataWhereNoMarkPresent() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_MARK.getAlfrescoTypeName());
