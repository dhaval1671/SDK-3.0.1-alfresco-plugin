...
/**
 * The Class RetrieveSpecimenMetadataTests.
 *
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk}
 */

public class RetrieveSpecimenMetadataTests extends SpecimenBaseTest {
     ...
     */
    @Test
    public void testRetrieveSpecimenMetadata() {
        ...
        WebResource webResource = client.resource(SPECIMEN_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        //check for Specimen document's size presence
        ...
        String docType = "\"documentType\"(.*?)\""+ Specimen.TYPE + "\"";
     ...
     */
    @Test
    public void testRetrieveSpecimenMetadataWithValidVersion() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_SPECIMEN.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_SPECIMEN_FILE_NAME);
        String SPECIMEN_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);
     ...
     */
    @Test
    public void testRetrieveSpecimenMetadataSpecimenDoesntExists() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_SPECIMEN.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
