...
public class VideoToImage_Update_MarkMutationTest extends VideoMarkBaseTest{
    ...
    public void firstCreateImageMarkThenTryToUpdateMultimediaMarkTest(){
        ...
        String VALUE_MRK_FILE_NAME = "VideoMarkToBeOverriddenByImage_Update_MarkFlow3.wmv";
    ...
    private void createVideoMark(UrlInputDto urlInput) {
        ...
        mrkParam.put(ParameterKeys.CONTENT_ATTACHEMENT.toString(), TransformVideoMarkBaseTest.CONTENT_MM_WMV); 
