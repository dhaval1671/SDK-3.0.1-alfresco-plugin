...
public class ImageToVideo_Update_MarkMutationTest extends VideoMarkBaseTest{
    ...
    public void firstCreateImageMarkThenTryToUpdateMultimediaMarkTest(){
        ...
        String VALUE_MRK_FILE_NAME = "ImageMarkToBeOverriddenByVideo_Update_MarkFlow2.jpeg";
        urlInput.setFileName(VALUE_MRK_FILE_NAME);
        createImageMark(urlInput);
        tryToUpdateVideoMark(urlInput);
    }
    ...
    private void tryToUpdateVideoMark(UrlInputDto urlInput) {
