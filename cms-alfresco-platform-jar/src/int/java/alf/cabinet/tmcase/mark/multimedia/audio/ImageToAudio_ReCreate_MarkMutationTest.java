...
public class ImageToAudio_ReCreate_MarkMutationTest extends VideoMarkBaseTest{
     ...
     */
    @Test
    public void firstCreateImageMarkThenTryToCreateAudioMarkTest(){
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_MARK.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        String VALUE_MRK_FILE_NAME = "ImageMarkToBeRe-CreatedByAudio_Create_MarkFlow1.jpeg";
        urlInput.setFileName(VALUE_MRK_FILE_NAME);
        createImageMark(urlInput);
        tryToCreateAudioMark(urlInput);
    }
    ...
    private void tryToCreateAudioMark(UrlInputDto urlInput) {
