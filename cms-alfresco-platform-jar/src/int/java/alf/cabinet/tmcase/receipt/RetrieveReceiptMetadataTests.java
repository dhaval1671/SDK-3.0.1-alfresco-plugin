...
/**
 * The Class RetrieveReceiptMetadataTests.
 *
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk}
 */

public class RetrieveReceiptMetadataTests extends ReceiptBaseTest {
    ...
    /**
     * Test retrieve receipt metadata.
     */
    @Test
    public void testRetrieveReceiptMetadata() {
        ...
        String RECEIPT_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);           

        WebResource webResource = client.resource(RECEIPT_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        //check for Receipt document's size presence
        ...
        String docType = "\"documentType\"(.*?)\""+ Receipt.TYPE + "\"";
        assertTrue(containsOneOrMoreOccurencesOfProvidedStringOfGivenRegEx( haystack, docType));          
    }

    /**
     * Test retrieve receipt metadata with valid version.
     */
    @Test
    public void testRetrieveReceiptMetadataWithValidVersion() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_RECEIPT.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_RECEIPT_FILE_NAME);
        String RECEIPT_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);          
    ...
    /**
     * Test retrieve receipt metadata receipt doesnt exists.
     */
    @Test
    public void testRetrieveReceiptMetadataReceiptDoesntExists() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_RECEIPT.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
