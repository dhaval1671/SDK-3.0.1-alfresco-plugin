...
public class DeleteRegistrationCertificateTests extends RegistrationCertificateBaseTest {
    ...
    public void registrationCertificateCreateAndRecreateTest() {
        ...
        registrationCertificateParam.put(ParameterKeys.METADATA.toString(), VALUE_REGISTRATION_CERTIFICATE_DELETE_METADATA);
        registrationCertificateParam.put(ParameterKeys.CONTENT_ATTACHEMENT.toString(),
                RegistrationCertificateBaseTest.CONTENT_REGISTRATION_CERTIFICATE_ATTACHMENT);
