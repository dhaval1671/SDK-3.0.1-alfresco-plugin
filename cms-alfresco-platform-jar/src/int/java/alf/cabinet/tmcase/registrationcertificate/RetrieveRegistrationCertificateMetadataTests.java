...
/**
 * The Class RetrieveRegistrationCertificateMetadataTests.
 *
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk}
 */

public class RetrieveRegistrationCertificateMetadataTests extends RegistrationCertificateBaseTest {
     ...
     */
    @Test
    public void testRetrieveRegistrationCertificateMetadata() {
        ...
        String REGISTRATION_CERTIFICATE_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl
                .retrieveDocumentMetadata(urlInput);
        WebResource webResource = client.resource(REGISTRATION_CERTIFICATE_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        String docType = "\"documentType\"(.*?)\"" + RegistrationCertificate.TYPE + "\"";
     ...
     */
    @Test
    public void testRetrieveRegistrationCertificateMetadataWithValidVersion() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_REGISTRATION_CERTIFICATE.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_REGISTRATION_CERTIFICATE_FILE_NAME);
        String REGISTRATION_CERTIFICATE_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl
