...
/**
 * The Class RetrieveSignatureMetadataTests.
 *
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk}
 */

public class RetrieveSignatureMetadataTests extends SignatureBaseTest {
     ...
     */
    @Test
    public void testRetrieveSignatureMetadata() {
        ...
        String SIGNATURE_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);
        WebResource webResource = client.resource(SIGNATURE_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        //check for Signature document's size presence
        ...
        String docType = "\"documentType\"(.*?)\""+ Signature.TYPE + "\"";
     ...
     */
    @Test
    public void testRetrieveSignatureMetadataWithValidVersion() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_SIGNATURE.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_SIGNATURE_FILE_NAME);
        String SIGNATURE_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);
     ...
     */
    @Test
    public void testRetrieveSignatureMetadataSignatureDoesntExists() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_SIGNATURE.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
