...
public class RetrieveWithdrawalMetadataTests extends WithdrawalBaseTest {
     ...
     */
    @Test
    public void testRetrieveWithdrawalMetadata() {
        ...
        String WITHDRAWAL_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);         

        WebResource webResource = client.resource(WITHDRAWAL_RETRIEVE_METADATA_WEBSCRIPT_URL);
        ...
        //check for Withdrawal document's size presence
        ...
        String docType = "\"documentType\"(.*?)\""+ Withdrawal.TYPE + "\"";
     ...
     */
    @Test
    public void testRetrieveWithdrawalMetadataWithValidVersion() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_WITHDRAWAL.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
        urlInput.setFileName(VALUE_WITHDRAWAL_FILE_NAME);
        String WITHDRAWAL_RETRIEVE_METADATA_WEBSCRIPT_URL = CaseRetrieveMetadataUrl.retrieveDocumentMetadata(urlInput);          
     ...
     */
    @Test
    public void testRetrieveWithdrawalMetadataWithdrawalDoesntExists() {
        UrlInputDto urlInput = new UrlInputDto(TradeMarkDocumentTypes.TYPE_WITHDRAWAL.getAlfrescoTypeName());
        urlInput.setSerialNumber(ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString());
