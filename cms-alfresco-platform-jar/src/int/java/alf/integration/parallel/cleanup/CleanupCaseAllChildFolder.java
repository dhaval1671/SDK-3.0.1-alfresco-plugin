package alf.integration.parallel.cleanup;
...
public class CleanupCaseAllChildFolder extends TmnguiBaseTest {
     ...
     */
    @Test
    public void cleanupAllCaseChildFolderTestData() {
        String WEBSCRIPT_EXT = "/cms/validate/" + "deleteAllCaseChildFolder" + "/"+ "a" + "/b/c";
