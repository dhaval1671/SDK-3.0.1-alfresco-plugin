 ...
 */
public class MadridUrlInputDto {
     ...
     *            the request
     */
    public MadridUrlInputDto(WebScriptRequest request) {
     ...
     *            the uri
     */
    public MadridUrlInputDto(RequestMethod httpMethodType, String uri) {
     ...
     *            the doc type
     */
    public MadridUrlInputDto(String docType) {
        this.docType = docType;
        this.qname = TradeMarkMadridTypes.getMadridQName(docType);
        this.cmsClass = TradeMarkMadridTypes.getMadridModelClassType(docType);
    }
     ...
     *            the doc sub type
     */
    public MadridUrlInputDto(String docType, String docSubType) {
        this.docType = docType;
