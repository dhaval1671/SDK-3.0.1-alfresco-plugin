...
public class IdmUrlInputDto {
     ...
     *            the request
     */
    public IdmUrlInputDto(WebScriptRequest request) {
     ...
     *            the uri
     */
    public IdmUrlInputDto(RequestMethod httpMethodType, String uri) {
     ...
     *            the doc type
     */
    public IdmUrlInputDto(String docType) {
        this.docType = docType;
        this.qname = TradeMarkPublicationTypes.getPublicationQName(docType);
        this.cmsClass = TradeMarkPublicationTypes.getPublicationModelClassType(docType);
    }
     ...
     *            the doc sub type
     */
    public IdmUrlInputDto(String docType, String docSubType) {
        this.docType = docType;
        this.docSubType = docSubType;
        this.qname = TradeMarkPublicationTypes.getPublicationQName(docType);
        this.cmsClass = TradeMarkPublicationTypes.getPublicationModelClassType(docSubType);
    }
