...
public class EogUrlInputDto {
     ...
     *            the request
     */
    public EogUrlInputDto(WebScriptRequest request) {
     ...
     *            the uri
     */
    public EogUrlInputDto(RequestMethod httpMethodType, String uri) {
     ...
     *            the doc type
     */
    public EogUrlInputDto(String docType) {
     ...
     *            the doc sub type
     */
    public EogUrlInputDto(String docType, String docSubType) {
        this.docType = docType;
