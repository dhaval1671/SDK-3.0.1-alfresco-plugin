...
public class LegalProceedingCleanupTestData extends TmnguiBaseTest {
    ...
    /**
     * Cleanup Madrid '77777777' data.
     */
    @Test
    public void cleanupLegalProceeding_77777777() {
        //String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEfileTestFolder" + "/"+ ParameterValues.VALUE_EFILE_TRADEMARKID.toString() + "/" + "all" + "/" + "c";
        String WEBSCRIPT_EXT = "/cms/validate/" + "deleteLegalProceedingTestFolder" + "/"+ ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString() + "/" + "b" + "/" + "c";
    ...
    @Test
    public void cleanupLegalProceeding_77777778() {
        //String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEfileTestFolder" + "/"+ ParameterValues.VALUE_EFILE_TRADEMARKID.toString() + "/" + "all" + "/" + "c";
        String WEBSCRIPT_EXT = "/cms/validate/" + "deleteLegalProceedingTestFolder" + "/"+ ParameterValues.VALUE_SERIAL_77777778_NUMBER.toString() + "/" + "b" + "/" + "c";
        String WEBSCRIPT_URL = alfUrl + WEBSCRIPT_EXT;          
        WebResource webResource = client.resource(WEBSCRIPT_URL);
        Builder b = webResource.type(MediaType.MULTIPART_FORM_DATA_TYPE);
        b = b.header("API-Security-Key", API_KEY);
    ...
    @Test
    public void cleanupLegalProceeding_77777779() {
        //String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEfileTestFolder" + "/"+ ParameterValues.VALUE_EFILE_TRADEMARKID.toString() + "/" + "all" + "/" + "c";
        String WEBSCRIPT_EXT = "/cms/validate/" + "deleteLegalProceedingTestFolder" + "/"+ ParameterValues.VALUE_SERIAL_77777779_NUMBER.toString() + "/" + "b" + "/" + "c";
        String WEBSCRIPT_URL = alfUrl + WEBSCRIPT_EXT;          
        WebResource webResource = client.resource(WEBSCRIPT_URL);
        Builder b = webResource.type(MediaType.MULTIPART_FORM_DATA_TYPE);
        b = b.header("API-Security-Key", API_KEY);
