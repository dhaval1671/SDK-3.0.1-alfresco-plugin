...
public class EogTemplateCleanupTestData extends TmnguiBaseTest {
    ...
    public void setUp() {
        ...
        // System.out.println(ALF_ADMIN_LOGIN_USER_ID +" <--> "+
        // ALF_ADMIN_LOGIN_PWD);
     ...
     */
    @Test
    public void cleanupEogTest777Data() {
        // String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEfileTestFolder" +
        // "/"+ ParameterValues.VALUE_EFILE_TRADEMARKID.toString() + "/" + "all"
        // + "/" + "c";
        String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEogTemplateTestFolder" + "/"
                + ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString() + "/" + "b" + "/" + "c";
