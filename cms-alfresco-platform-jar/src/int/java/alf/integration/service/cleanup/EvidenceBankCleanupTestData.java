...
public class EvidenceBankCleanupTestData extends TmnguiBaseTest {
     ...
     */
    @Test
    public void cleanupEvidenceBankWebcapture() {
        //String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEfileTestFolder" + "/"+ ParameterValues.VALUE_EFILE_TRADEMARKID.toString() + "/" + "all" + "/" + "c";
        String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEvidenceBankWebcaptureFolder" + "/"+ TradeMarkModel.WEBCAPTURE_FOLDER_NAME + "/" + "b" + "/" + "c";
