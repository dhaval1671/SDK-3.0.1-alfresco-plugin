...
public class MadridCleanupTestData extends TmnguiBaseTest {
     ...
     */
    @Test
    public void cleanupMadrid_77777777() {
        //String WEBSCRIPT_EXT = "/cms/validate/" + "deleteEfileTestFolder" + "/"+ ParameterValues.VALUE_EFILE_TRADEMARKID.toString() + "/" + "all" + "/" + "c";
        String WEBSCRIPT_EXT = "/cms/validate/" + "deleteMadridTestFolder" + "/"+ ParameterValues.VALUE_SERIAL_77777777_NUMBER.toString() + "/" + "b" + "/" + "c";
