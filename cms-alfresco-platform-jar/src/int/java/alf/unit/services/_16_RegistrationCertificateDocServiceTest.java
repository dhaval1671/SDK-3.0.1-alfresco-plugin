 ...
 *
 */
public class _16_RegistrationCertificateDocServiceTest extends CmsCommonTest {

    /** The Constant Attachment_FILE_NAME. */
    private static final String FILE_NAME = "registrationcertification.pdf";

    /** The Constant CASE_NUMBER. */
    private static final String CASE_NUMBER = "88888888";

    /** The Constant JSON_STRING. */
    private static final String JSON_STRING = "{     \"modifiedByUserId\": \"User XYZ\",     \"documentAlias\": \"nickname\",     \"sourceSystem\": \"TMNG\",     \"sourceMedia\": \"electronic\",     \"sourceMedium\": \"upload\",     \"accessLevel\": \"internal\",     \"scanDate\": \"2014-04-23T13:42:24.962-04:00\" } ";

    /** The Constant CONTENT_FILE_PATH. */
    private static final String CONTENT_FILE_PATH = "src//test//resources//registrationcertificate//registrationcertificate.pdf";

    /** The doc q name. */
    QName docQName = TradeMarkModel.REGISTRATION_CERTIFICATE_QNAME;

    /** The doc type. */
    String docType = RegistrationCertificate.TYPE;
    /** The log. */
    private static Logger LOG = Logger.getLogger(_16_RegistrationCertificateDocServiceTest.class);
    ...
    /**
     * Creates the RegistrationCertificate inside case folder.
     */
    @Test
    public void createRegistrationCertificate() {
    ...
    @Test
    public void deleteRegistrationCertificate() {
        setupDocuments(CASE_NUMBER, docQName);
        createRegistrationCertificate();
        LOG.info("### Executing " + Thread.currentThread().getStackTrace()[1].getMethodName() + " ####");
        TmngAlfResponse response = deleteDocument(docType, CASE_NUMBER, FILE_NAME);
        LOG.info("response>>>" + response);
        assertNotNull(response);
        LOG.info("Deleted " + FILE_NAME + " in " + CASE_NUMBER);
    }
