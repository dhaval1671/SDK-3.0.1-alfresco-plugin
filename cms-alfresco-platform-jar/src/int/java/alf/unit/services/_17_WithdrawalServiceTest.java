...
/**
 * Unit testing for WithdrawalService.
 *
 */
public class _17_WithdrawalServiceTest extends CmsCommonTest {

    /** The Constant WITHDRAWAL_FILE_NAME. */
    private static final String FILE_NAME = "FirstWithdrawal.pdf";
    ...
    /** The doc q name. */
    QName docQName = TradeMarkModel.WITHDRAWAL_QNAME;

    /** The doc type. */
    String docType = Withdrawal.TYPE;
    /** The log. */
    private static Logger LOG = Logger.getLogger(_17_WithdrawalServiceTest.class);
    ...
    /**
     * Creates the Withdrawal inside case folder.
     */
    @Test
