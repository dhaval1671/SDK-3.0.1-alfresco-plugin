 ...
 *
 */
public class _08_NoticeDocServiceTest extends CmsCommonTest {

    /** The Constant Attachment_FILE_NAME. */
    private static final String FILE_NAME = "FirstNotice.pdf";

    /** The Constant CASE_NUMBER. */
    private static final String CASE_NUMBER = "88888888";

    /** The Constant JSON_STRING. */
    public static final String JSON_STRING = "{     \"modifiedByUserId\": \"User XYZ\",     \"documentAlias\": \"nickname\",     \"sourceSystem\": \"TMNG\",     \"sourceMedia\": \"electronic\",     \"sourceMedium\": \"upload\",     \"accessLevel\": \"public\",     \"scanDate\": \"2014-04-23T13:42:24.962-04:00\" } ";

    /** The Constant CONTENT_FILE_PATH. */
    private static final String CONTENT_FILE_PATH = "src//test//resources//notice//1_Notice1.0.pdf";

    /** The doc q name. */
    QName docQName = TradeMarkModel.NOTICE_QNAME;
    
    /** The doc type. */
    String docType = Notice.TYPE;
    /** The log. */
    private static Logger LOG = Logger.getLogger(_08_NoticeDocServiceTest.class);
