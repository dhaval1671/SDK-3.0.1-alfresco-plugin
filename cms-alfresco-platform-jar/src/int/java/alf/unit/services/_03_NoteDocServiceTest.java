...
/**
 * Unit testing for NoteService.
 *
 */
public class _03_NoteDocServiceTest extends CmsCommonTest {

    /** The Constant NOTE_FILE_NAME. */
    private static final String FILE_NAME = "FirstNote.pdf";
    ...
    private static final String UPDATE_JSON_STRING = "{     \"modifiedByUserId\": \"Updated\",     \"documentAlias\": \"nickname\",     \"sourceSystem\": \"TMNG\",     \"sourceMedia\": \"electronic\",     \"sourceMedium\": \"upload\",     \"accessLevel\": \"public\",     \"scanDate\": \"2014-04-23T13:42:24.962-04:00\" } ";

    /** The Constant CONTENT_FILE_PATH. */
    private static final String CONTENT_FILE_PATH = "src//test//resources//note//1_Note1.0.pdf";

    /** The log. */
    private static Logger LOG = Logger.getLogger(_03_NoteDocServiceTest.class);

    /** The doc q name. */
    QName docQName = TradeMarkModel.NOTE_QNAME;
    
    /** The doc type. */
    String docType = Note.TYPE;
    ...
    /**
     * Creates the note inside case folder.
     */
    @Test
    public void createNote() {
        ...
        LOG.debug("Created " + FILE_NAME + " in " + CASE_NUMBER);
    }
