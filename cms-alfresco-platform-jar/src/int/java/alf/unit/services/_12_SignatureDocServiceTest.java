 ...
 *
 */
public class _12_SignatureDocServiceTest extends CmsCommonTest {

    /** The Constant Attachment_FILE_NAME. */
    private static final String FILE_NAME = "Signature_1_Version1.0.docx";

    /** The Constant CASE_NUMBER. */
    private static final String CASE_NUMBER = "88888888";

    /** The Constant JSON_STRING. */
    private static final String JSON_STRING = "{\"documentAlias\": \"DocNameForTmngUiDisplay\", \"modifiedByUserId\" : \"CreateSignatureIntegraTestV_1_0\",   \"sourceSystem\" : \"TMNG\",   \"sourceMedia\" : \"electronic\",   \"sourceMedium\" : \"upload\",   \"accessLevel\" : \"public\",   \"scanDate\" : \"2014-04-23T13:42:24.962-04:00\" }";

    /** The Constant CONTENT_FILE_PATH. */
    private static final String CONTENT_FILE_PATH = "src//test//resources//signature//signature.pdf";

    /** The doc q name. */
    QName docQName = TradeMarkModel.SIGNATURE_QNAME;
    
    /** The doc type. */
    String docType = Signature.TYPE;
    /** The log. */
    private static Logger LOG = Logger.getLogger(_12_SignatureDocServiceTest.class);
