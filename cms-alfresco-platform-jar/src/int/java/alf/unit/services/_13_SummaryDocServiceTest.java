 ...
 *
 */
public class _13_SummaryDocServiceTest extends CmsCommonTest {

    /** The Constant Attachment_FILE_NAME. */
    private static final String FILE_NAME = "X-Search Summary.docx";
    ...
    private static final String CONTENT_FILE_PATH = "src//test//resources//summary//X-Search Summary.docx";
    ...
    /** The log. */
    private static Logger LOG = Logger.getLogger(_13_SummaryDocServiceTest.class);
