...
/**
 * Check Alfresco Health status test cases.
 * 
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk}
 *
 */

public class AlfrescoHealthStatusTests extends CentralBase {
    ...
    /**
     * Test alfresco mount point and DB.
     */
    @Test
    public void testAlfrescoHealthStatus() {
        String ALFRESCO_HELLO_WEBSCRIPT_URL = AlfrescoHealthStatusUrl.alfrescoHealthStatus();
