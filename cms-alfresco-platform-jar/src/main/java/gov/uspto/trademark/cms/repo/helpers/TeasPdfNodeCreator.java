 ...
 */
@Component("teaspdfDocumentNodeCreator")
public class TeasPdfNodeCreator extends AbstractNodeCreator {
     ...
     * 
     * Eg: 12345678 will be created as 123/456/12345678/teaspdf
     *
     * @param id
     *            the id
     * @return the node ref
    ...
    public synchronized NodeRef createNode(final String id) {
        ...
        RetryingTransactionCallback<NodeRef> callback = new RetryingTransactionCallback<NodeRef>() {
            ...
            public NodeRef execute() throws Throwable {
                ...
                parentNodeRef = createFolderNode(parentNodeRef, TradeMarkModel.TEAS_PDF_FOLDER_NAME, ContentModel.TYPE_FOLDER);
