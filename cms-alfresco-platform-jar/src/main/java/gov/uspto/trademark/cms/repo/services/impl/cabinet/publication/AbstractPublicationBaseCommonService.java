 ...
 */
public abstract class AbstractPublicationBaseCommonService extends AbstractCommonService {
     ...
     */
    public AbstractPublicationBaseCommonService(CmsNodeCreator caseNodeCreator, CmsNodeLocator cmsNodeLocator) {
    ...
    public <T extends AbstractBaseType> TmngAlfResponse updateDocument(final String id, final String fileName, final QName type,
        ...
        if (nodeRef != null) {
            ...
            publicationResponse.setDocumentId(id, type.getLocalName(), fileName);
            publicationResponse.setId(id);
        }
