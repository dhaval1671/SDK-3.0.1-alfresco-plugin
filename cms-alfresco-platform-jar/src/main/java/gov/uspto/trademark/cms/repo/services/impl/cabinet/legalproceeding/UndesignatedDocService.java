 ...
 *
 */
@Component("UndesignatedDocService")
public class UndesignatedDocService extends AbstractLegalProceedingCommonService {
     ...
     */
    @Autowired
    public UndesignatedDocService(LegalProceedingNodeCreator legalProceedingNodeCreator,
    ...
    public TmngAlfResponse create(final String id, final String fileName, final ContentItem content,
        ...
        return createDocument(id, fileName, content, TradeMarkModel.UNDESIGNATED_QNAME, properties, Undesignated.class);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber) {
        return retrieveContent(legalProceedingNodeLocator, TradeMarkModel.UNDESIGNATED_QNAME, id, fileName, versionNumber);
    }
    ...
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber) {
        return retrieveMetadata(legalProceedingNodeLocator, id, fileName, versionNumber, TradeMarkModel.UNDESIGNATED_QNAME,
                Undesignated.class);
    }
