 ...
 */
public class RetrieveLegalProceedingMetadataWebScript extends AbstractCmsCommonWebScript {
    ...
    protected void executeService(WebScriptRequest webScriptRequest, WebScriptResponse webScriptResponse) {
        try {
            ...
            byte[] metadata = legalProceedingServiceFactory.getLegalProceedingService(legalProceedingServiceMap.get(docType))
                    .retrieveMetadata(id, fileName, versionNumber, accessLevelFilter);
            if (metadata == null) {
