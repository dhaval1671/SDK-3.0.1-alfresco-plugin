...
/**
 * This service will implement the order(legal-proceeding) type functionality.
 * 
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk} 11/30/2016.
 *
 */
@Component("OrderDocService")
public class OrderDocService extends AbstractLegalProceedingCommonService {
     ...
     */
    @Autowired
    public OrderDocService(LegalProceedingNodeCreator legalProceedingNodeCreator,
    ...
    public TmngAlfResponse create(final String id, final String fileName, final ContentItem content,
        ...
        return createDocument(id, fileName, content, TradeMarkModel.ORDER_QNAME, properties, Order.class);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber) {
        return retrieveContent(legalProceedingNodeLocator, TradeMarkModel.ORDER_QNAME, id, fileName, versionNumber);
    }

    @Override
    public ContentReader retrieveContent(String id, String fileName, String versionNumber, CmsDataFilter dataFilter) {
        return retrieveContent(legalProceedingNodeLocator, TradeMarkModel.ORDER_QNAME, id, fileName, versionNumber, dataFilter);
    }

    @Override
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber) {
        return retrieveMetadata(legalProceedingNodeLocator, id, fileName, versionNumber, TradeMarkModel.ORDER_QNAME, Order.class);
    }
