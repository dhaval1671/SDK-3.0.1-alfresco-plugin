 ...
 *
 */
@Component("SpecimenDocService")
public class SpecimenDocService extends AbstractCaseCommonService {
     ...
     */
    @Autowired
    public SpecimenDocService(CmsNodeCreator caseNodeCreator, CmsNodeLocator caseNodeLocator) {
    ...
    public TmngAlfResponse create(final String id, final String fileName, final ContentItem content,
        ...
        return createDocument(id, fileName, content, TradeMarkModel.SPECIMEN_QNAME, properties, Specimen.class);
    }
    ...
    public TmngAlfResponse update(final String id, final String fileName, final ContentItem content,
            Map<String, Serializable> properties) {
        return updateDocument(id, fileName, content, TradeMarkModel.SPECIMEN_QNAME, properties, Specimen.class);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber) {
        return retrieveContent(cmsNodeLocator, TradeMarkModel.SPECIMEN_QNAME, id, fileName, versionNumber);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber, CmsDataFilter dataFilter) {
        return retrieveContent(cmsNodeLocator, TradeMarkModel.SPECIMEN_QNAME, id, fileName, versionNumber, dataFilter);
    }
    ...
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber) {
        return retrieveMetadata(cmsNodeLocator, id, fileName, versionNumber, TradeMarkModel.SPECIMEN_QNAME, Specimen.class);
    }
    ...
    public TmngAlfResponse updateMetadata(String id, String fileName, Map<String, Serializable> properties) {
        return updateDocument(id, fileName, null, TradeMarkModel.SPECIMEN_QNAME, properties, Specimen.class);
