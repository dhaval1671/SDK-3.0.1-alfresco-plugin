 ...
 *
 */
@Component("PleadingDocService")
public class PleadingDocService extends AbstractLegalProceedingCommonService {
     ...
     */
    @Autowired
    public PleadingDocService(LegalProceedingNodeCreator legalProceedingNodeCreator,
    ...
    public TmngAlfResponse create(final String id, final String fileName, final ContentItem content,
        ...
        return createDocument(id, fileName, content, TradeMarkModel.PLEADING_QNAME, properties, Pleading.class);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber) {
        return retrieveContent(legalProceedingNodeLocator, TradeMarkModel.PLEADING_QNAME, id, fileName, versionNumber);
    }
    ...
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber) {
        return retrieveMetadata(legalProceedingNodeLocator, id, fileName, versionNumber, TradeMarkModel.PLEADING_QNAME,
                Pleading.class);
    }
