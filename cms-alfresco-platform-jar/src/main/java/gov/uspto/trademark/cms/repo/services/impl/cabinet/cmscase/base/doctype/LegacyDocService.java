 ...
 *
 */
@Component("LegacyDocService")
public class LegacyDocService extends AbstractCaseCommonService {

    /**
     * Instantiates a new legacy doc service.
     *
     ...
     */
    @Autowired
    public LegacyDocService(CmsNodeCreator caseNodeCreator, CmsNodeLocator caseNodeLocator) {
        super(caseNodeCreator, caseNodeLocator);
    }

    /*
     * This method is used to create the legacy document type
     * 
     * @see
    ...
    public TmngAlfResponse create(final String id, final String fileName, final ContentItem content,
        ...
        return createDocument(id, fileName, content, TradeMarkModel.LEGACY_QNAME, properties, Legacy.class);
    }

    /*
     * This method is used to update the legacy document type
     * 
     * @see
    ...
    public TmngAlfResponse update(final String id, final String fileName, final ContentItem content,
            Map<String, Serializable> properties) {
        return updateDocument(id, fileName, content, TradeMarkModel.LEGACY_QNAME, properties, Legacy.class);
    }

    /*
     * This method is used to retrieve the legacy document content
     * 
     * @see
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber) {
        return retrieveContent(cmsNodeLocator, TradeMarkModel.LEGACY_QNAME, id, fileName, versionNumber);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber, CmsDataFilter dataFilter) {
        return retrieveContent(cmsNodeLocator, TradeMarkModel.LEGACY_QNAME, id, fileName, versionNumber, dataFilter);
    }

    /*
     * This method is used to retrieve the legacy document metadata
     * 
     * @see
    ...
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber) {
        return retrieveMetadata(cmsNodeLocator, id, fileName, versionNumber, TradeMarkModel.LEGACY_QNAME, Legacy.class);
    }
    ...
    public TmngAlfResponse updateMetadata(String id, String fileName, Map<String, Serializable> properties) {
        return updateDocument(id, fileName, null, TradeMarkModel.LEGACY_QNAME, properties, Legacy.class);
