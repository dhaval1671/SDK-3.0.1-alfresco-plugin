...
/**
 * This service will implement the brief(legal-proceeding) type functionality.
 * 
 * @author Sanjay Tank {linkedin.com/in/sanjaytaunk} 11/30/2016.
 *
 */
@Component("BriefDocService")
public class BriefDocService extends AbstractLegalProceedingCommonService {
     ...
     */
    @Autowired
    public BriefDocService(LegalProceedingNodeCreator legalProceedingNodeCreator,
    ...
    public TmngAlfResponse create(final String id, final String fileName, final ContentItem content,
        ...
        return createDocument(id, fileName, content, TradeMarkModel.BRIEF_QNAME, properties, Brief.class);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber) {
        return retrieveContent(legalProceedingNodeLocator, TradeMarkModel.BRIEF_QNAME, id, fileName, versionNumber);
    }

    @Override
    public ContentReader retrieveContent(String id, String fileName, String versionNumber, CmsDataFilter dataFilter) {
        return retrieveContent(legalProceedingNodeLocator, TradeMarkModel.BRIEF_QNAME, id, fileName, versionNumber, dataFilter);
    }

    @Override
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber) {
        return retrieveMetadata(legalProceedingNodeLocator, id, fileName, versionNumber, TradeMarkModel.BRIEF_QNAME, Brief.class);
    }
