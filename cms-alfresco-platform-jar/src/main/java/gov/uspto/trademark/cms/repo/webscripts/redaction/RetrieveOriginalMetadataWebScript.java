...
/**
 * This class is used to retrieve original document metadata for a redacted
 * document.
 * 
 * @author vnondapaka
 *
 */
public class RetrieveOriginalMetadataWebScript extends AbstractCmsCommonWebScript {
    ...
    protected void executeService(WebScriptRequest webScriptRequest, WebScriptResponse webScriptResponse) {
        try {
            ...
            byte[] metadata = cmsRedactionService.retrieveOriginalMetadata(id, fileName, docType, accessLevelFilter);
