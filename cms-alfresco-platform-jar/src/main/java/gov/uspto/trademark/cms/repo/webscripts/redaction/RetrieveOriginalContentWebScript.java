...
/**
 * This class is used to retrieve the original document content for a redacted
 * document.
 * 
 * @author vnondapaka
 *
 */
public class RetrieveOriginalContentWebScript extends AbstractCmsCommonWebScript {
    ...
    protected void executeService(WebScriptRequest webScriptRequest, WebScriptResponse webScriptResponse) {
        try {
            ...
            ContentReader contentReader = cmsRedactionService.retrieveOriginalContent(id, fileName, docType, accessLevelFilter);
