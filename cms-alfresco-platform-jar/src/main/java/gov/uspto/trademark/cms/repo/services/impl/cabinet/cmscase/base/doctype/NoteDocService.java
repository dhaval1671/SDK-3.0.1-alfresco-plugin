 ...
 *
 */
@Component("NoteDocService")
public class NoteDocService extends AbstractCaseCommonService {

    /**
     * Instantiates a new note doc service.
     *
     ...
     */
    @Autowired
    public NoteDocService(CmsNodeCreator caseNodeCreator, CmsNodeLocator caseNodeLocator) {
    ...
    public TmngAlfResponse create(final String id, final String fileName, final ContentItem content,
        ...
        return createDocument(id, fileName, content, TradeMarkModel.NOTE_QNAME, properties, Note.class);
    }
    ...
    public TmngAlfResponse update(final String id, final String fileName, final ContentItem content,
            Map<String, Serializable> properties) {
        return updateDocument(id, fileName, content, TradeMarkModel.NOTE_QNAME, properties, Note.class);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber) {
        return retrieveContent(cmsNodeLocator, TradeMarkModel.NOTE_QNAME, id, fileName, versionNumber);
    }
    ...
    public ContentReader retrieveContent(String id, String fileName, String versionNumber, CmsDataFilter dataFilter) {
        return retrieveContent(cmsNodeLocator, TradeMarkModel.NOTE_QNAME, id, fileName, versionNumber, dataFilter);
    }
    ...
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber) {
        return retrieveMetadata(cmsNodeLocator, id, fileName, versionNumber, TradeMarkModel.NOTE_QNAME, Note.class);
    }
    ...
    public byte[] retrieveMetadata(String id, String fileName, String versionNumber, CmsDataFilter dataFilter) {
        return retrieveMetadata(cmsNodeLocator, id, fileName, versionNumber, TradeMarkModel.NOTE_QNAME, Note.class, dataFilter);
    }
    ...
    public TmngAlfResponse updateMetadata(String id, String fileName, Map<String, Serializable> properties) {
        return updateDocument(id, fileName, null, TradeMarkModel.NOTE_QNAME, properties, Note.class);
    }
}
