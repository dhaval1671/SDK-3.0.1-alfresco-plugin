package gov.uspto.trademark.cms.repo.webscripts.create;
 ...
 *
 */
public class CreateWebScript extends AbstractCmsCommonWebScript {

    private static final Logger log = LoggerFactory.getLogger(CreateWebScript.class);
