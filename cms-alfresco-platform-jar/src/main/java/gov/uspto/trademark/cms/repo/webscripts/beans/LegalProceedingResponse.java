 ...
 *
 */
public class LegalProceedingResponse extends TmngAlfResponse {
    ...
    public void setDocumentId(String serialNumber, String type, String fileName) {
        setDocumentId(new DocumentId(TradeMarkModel.LEGAL_PROCEEDING_FOLDER_NAME, serialNumber, type, fileName));
    }
